            ...
            {(urgentTasks.length > 0 || importantTasks.length > 0 || overdueTasks.length > 0) && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {urgentTasks.length > 0 && (
                  <Card className="border-red-200 bg-red-50 dark:bg-red-900/10 cursor-pointer hover:shadow-md transition-shadow"
                        onClick={() => {
                ...
                {importantTasks.length > 0 && (
                  <Card className="border-yellow-200 bg-yellow-50 dark:bg-yellow-900/10 cursor-pointer hover:shadow-md transition-shadow"
                        onClick={() => {
                ...
                {overdueTasks.length > 0 && (
                  <Card className="border-orange-200 bg-orange-50 dark:bg-orange-900/10 cursor-pointer hover:shadow-md transition-shadow"
                        onClick={() => {
